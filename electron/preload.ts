...
contextBridge.exposeInMainWorld('cyberNotesAPI', {
  ...
  getDrafts: () => ipcRenderer.invoke('drafts:getAll'),
  saveDraft: (draft: any, flushNow = false) => ipcRenderer.invoke('drafts:save', draft, flushNow),
  deleteDraft: (noteId: string) => ipcRenderer.invoke('drafts:delete', noteId),
