  ...
  return (
    <div
      style={{
        ...
        inset: 0,
        zIndex: 999999,
        background: 'radial-gradient(ellipse at 50% 45%, color-mix(in srgb, var(--accent, #6c63e6) 16%, transparent) 0%, color-mix(in srgb, var(--bg-app, #0d0e18) 96%, transparent) 55%, #08090e 100%)',
        display: 'flex',
    ...
    >
      <style>{`
        ...
        @keyframes cyberPulse {
          0%, 100% { transform: scale(1); filter: drop-shadow(0 0 14px var(--accent-glow, rgba(108, 99, 230, 0.4))); }
          50% { transform: scale(1.04); filter: drop-shadow(0 0 24px var(--accent-glow, rgba(108, 99, 230, 0.7))); }
        }
      ...
      >
        ...
        <div style={{ position: 'relative', width: 84, height: 84, minWidth: 84, minHeight: 84, flex: '0 0 84px', aspectRatio: '1 / 1', boxSizing: 'border-box', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: 20 }}>
          ...
          <div
            style={{
              ...
              borderTopColor: 'var(--accent, #6c63e6)',
              borderRightColor: 'color-mix(in srgb, var(--accent, #6c63e6) 35%, transparent)',
          ...
          <div
            style={{
              ...
              inset: 6,
              borderRadius: '50%',
              border: '1px dashed color-mix(in srgb, var(--accent-light, #968fff) 35%, transparent)',
        ...
        <div
          style={{
            ...
            background: 'linear-gradient(135deg, #ffffff 40%, var(--accent-light, #968fff) 100%)',
        ...
        >
          <div
            style={{
              ...
              top: 0,
              bottom: 0,
              background: 'linear-gradient(90deg, transparent, var(--accent, #6c63e6), var(--accent-light, #968fff), transparent)',
              boxShadow: '0 0 10px var(--accent-glow, rgba(108, 99, 230, 0.6))',
              borderRadius: 999,
